...
| [Part II: Deciding What Deserves Organizational Attention](parts/part-2.md) | II | Assembly structure | Part divider |
| [The Front Door](chapters/02-front-door.md) | II — Deciding What Deserves Organizational Attention | Work-Intake-Is-an-Organizational-System.md | Assembled source cut |
| [Future Edition: Portfolio Judgment](chapters/03-portfolio-judgment.md) | II — Deciding What Deserves Organizational Attention | Gap-map synthesis plus Work Intake and Process Improvement | Unnumbered editorial placeholder |
| [Part III: Framing and Authorizing Work](parts/part-3.md) | III | Assembly structure | Part divider |
| [Frame the Work Before Designing It](chapters/04-frame-before-design.md) | III — Framing and Authorizing Work | Framing-Technical-Work-Before-Design.md | Assembled source cut |
| [Make the Commitment Legitimate](chapters/05-legitimate-commitment.md) | III — Framing and Authorizing Work | Work-Intake-Is-an-Organizational-System.md | Assembled source cut |
...
| [Development Is an Organizational Architecture](chapters/11-development-architecture.md) | V — Developing and Acquiring Capability | Talent-Development-Architecture.md | Assembled source cut |
| [Management Is Evidence Infrastructure](chapters/12-management-evidence.md) | V — Developing and Acquiring Capability | Coaching-and-Calibration-Guide.md plus TDA | Merged source cut |
| [Create Safe Reps and Allocate Opportunity](chapters/13-safe-reps-and-opportunity.md) | V — Developing and Acquiring Capability | Talent-Development-Architecture.md | Assembled source cut |
| [Future Edition: Hiring Capability](chapters/14-hiring-capability.md) | V — Developing and Acquiring Capability | TDA plus gap-map synthesis | Unnumbered editorial placeholder with current source |
| [Selecting External Capability](chapters/15-selecting-external-capability.md) | V — Developing and Acquiring Capability | RFPs-and-Vendor-Selection-as-Evidence-Systems.md | Assembled source cut |
| [Proving and Accepting External Capability](chapters/16-proving-external-capability.md) | V — Developing and Acquiring Capability | RFPs-and-Vendor-Selection-as-Evidence-Systems.md | Assembled source cut |
| [Part VI: Reconciling the Enterprise](parts/part-6.md) | VI | Assembly structure | Part divider |
| [Future Edition: Reconciling the Enterprise](chapters/17-reconciling-enterprise.md) | VI — Reconciling the Enterprise | Gap-map synthesis from domain reconciliation chapters | Unnumbered editorial placeholder |
| [Future Edition: AI, Context, and Organizational Leverage](chapters/18-ai-context-leverage.md) | VI — Reconciling the Enterprise | TDA plus gap-map synthesis | Unnumbered editorial placeholder with current source |
| [An Implementation Roadmap](chapters/19-implementation-roadmap.md) | VI — Reconciling the Enterprise | Process-Improvement-Framework.md plus gap-map synthesis | Provisional synthesis |
| [Reusable Instruments and References](appendices/00-appendices.md) | Appendices | Assembly boundary | Appendix divider |
| [Appendix A: Framing and Work-Item Tools](appendices/a-framing-and-work-item-tools.md) | Appendices | Framing and Writing Work Items | Selected instruments |
| [Appendix B: Conversation Planner](appendices/b-conversation-planner.md) | Appendices | Conversation Planner.md | Worksheet |
| [Appendix C: Talent Development Workbook](appendices/c-tda-workbook.md) | Appendices | Four TDA templates | Implementation workbook |
| [Appendix D: Career Progression Reference](appendices/d-career-reference.md) | Appendices | Career-Progression-Guide.md | Selected reference |
| [Appendix E: Vendor-Selection Tools](appendices/e-rfp-tools.md) | Appendices | RFP appendix | Selected instruments |
| [Appendix F: Socratic Leadership Seminar](appendices/f-socratic-seminar.md) | Appendices | Socratic-Leadership-Seminar.md | Case study and implementation guide |
