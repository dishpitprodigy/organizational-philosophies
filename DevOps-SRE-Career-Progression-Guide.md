...
**Example title:** DevOps Engineering Lead

### Core accountability

Provides first-line supervision to individual contributors, accountable primarily for the output of a defined team or sub-team and for the development of the people on it. Acts as a working advisor to the unit and steps into the technical work when schedules or problems require it.

### Scope and complexity

- Owns the execution of a defined team or sub-team against goals set above.
- Works within an established team and procedural framework rather than designing it.
- Exercises judgment within defined processes to assign work and resolve day-to-day problems.
- Balances delivery commitments against the team's capacity, skills, and development needs.

### Autonomy and influence

- Receives defined objectives and the processes by which to meet them.
- Directs employees according to established policies and management guidance.
- Has work reviewed by management against whether team objectives were met.
- Builds the working relationships and feedback habits that hold a team together.

### Observable evidence

- The team consistently meets its commitments with healthy, sustainable execution.
- Direct reports receive timely feedback and demonstrate measurable development.
- Problems and risks are surfaced and resolved or escalated rather than absorbed silently.
- The lead is trusted by both the team and adjacent partners as a reliable point of accountability.

### Boundary to MGR5

MGR4 supervises one team within a framework set by others. MGR5 owns the results, staffing, priorities, and processes of a team or department, determines how resources are used to meet goals, and may lead through other leads.

---

## MGR5 — Manager

**Example title:** Manager, DevOps Engineering

### Core accountability

Manages a team or department—potentially through one or more team leads—with end-to-end responsibility for results, staffing, priorities, and the processes by which the work gets done.

### Scope and complexity

- Owns the outcomes of a section or department of diverse scope.
- Develops and administers goals, schedules, and performance requirements; may hold budget responsibility.
- Follows and improves operational frameworks rather than only operating within them.
- Reads current business and technical trends and aligns team priorities accordingly.

### Autonomy and influence

- Receives objectives and determines how to deploy resources to meet them.
- Provides guidance to reports in alignment with team frameworks and recommends changes to those frameworks.
- Establishes procedures that affect the immediate organization.
- Acts as advisor to reports to help them meet goals and resolve problems.

### Observable evidence

- The department delivers results predictably across cycles, not only in occasional pushes.
- Staffing, hiring, and development decisions visibly strengthen the team over time.
- Process or prioritization changes the manager introduced improved a measurable outcome.
- Reports grow in scope and capability under the manager's leadership.

### Boundary to MGR6

MGR5 owns one team or department. MGR6 oversees the work and teams of two or more departments, including their costs, strategies, and staffing, and may have managers reporting to them.

---

## MGR6 — Senior Manager

**Example title:** Senior Manager, DevOps Engineering

### Core accountability

Manages the work and teams of two or more departments, overseeing cost, strategy, and staffing across them. Depending on size and need, may lead other managers.

### Scope and complexity

- Owns outcomes spanning multiple departments that require in-depth knowledge of organizational objectives.
- Establishes and assures adherence to budgets, schedules, work plans, and performance expectations.
- Resolves tradeoffs and dependencies between departments rather than within one.
- Connects departmental execution to broader organizational goals.

### Autonomy and influence

- Establishes operational objectives and work plans and assigns work to the appropriate managers or leads.
- Has objectives reviewed by senior management against organizational success.
- Develops, modifies, and executes work that affects immediate operations and may have company-wide effect.
- Builds alignment across departments with differing priorities and constraints.

### Observable evidence

- Multiple departments operate coherently against a shared plan the senior manager set.
- Cross-department budgets, schedules, and expectations are met without persistent firefighting.
- Managers developed under this role take on greater scope successfully.
- A multi-department change measurably improved cost, delivery, reliability, or capability.

### Boundary to MGR7

MGR6 leads two or more departments. MGR7 leads a broad function through several department managers, with overall control of planning, staffing, budgeting, and the methods the function uses.

---

## MGR7 — Director

**Example title:** Director, DevOps & SRE

### Core accountability

Leads a broad functional area through several department managers, with overall control of planning, staffing, budgeting, managing expense priorities, and recommending and implementing changes to methods.

### Scope and complexity

- Owns a broad function whose issues require in-depth knowledge of the company.
- Participates in creating the methods, techniques, and evaluation criteria used for projects, programs, and people.
- Ensures budgets and schedules meet company requirements.
- Anticipates how functional decisions affect adjacent functions and long-range plans.

### Autonomy and influence

- Participates with other senior managers to establish strategic plans and objectives.
- Makes final decisions on administrative and operational matters for the function.
- Ensures effective achievement of objectives across multiple departments and their managers.
- Represents the function in cross-functional and senior-leadership planning.

### Observable evidence

- The function delivers against strategy across planning cycles, not only on individual programs.
- Methods or evaluation criteria the director established are adopted and improve outcomes.
- Department managers within the function grow and succeed under the director's leadership.
- Functional planning, budgeting, and staffing decisions hold up under company-level scrutiny.

### Boundary to MGR8

MGR7 leads one broad function. MGR8 leads one or more functional areas, product groups, or service areas through senior managers, working consistently with abstract, cross-functional problems and setting direction for major areas.

---

## MGR8 — Senior Director

**Example title:** Senior Director, DevOps & SRE

### Core accountability

Leads one or more functional areas, product groups, or service areas through senior managers who hold overall responsibility for the successful operation of their assigned areas.

### Scope and complexity

- Works consistently with abstract ideas and situations across functional areas of the business.
- Through assessment of intangible variables, identifies and evaluates fundamental issues and sets strategy and direction for major functional areas.
- Requires in-depth knowledge of the functional area, business strategies, and company goals.
- Balances long-range positioning against near-term operational demands across areas.

### Autonomy and influence

- Develops company or organizational policies and oversees their implementation.
- Provides direction to senior managers across several areas, groups, or operations.
- Uses detailed knowledge of the company to promote innovative concepts and new ideas.
- Builds alignment among senior leaders where no single area owns the whole problem.

### Observable evidence

- Multiple functional areas operate coherently under direction this role established.
- Policies or strategies introduced at this level produce sustained organizational outcomes.
- Senior managers developed under this role take ownership of major areas.
- The organization's direction in these areas is materially shaped by this leader's judgment.

### Boundary to EX9

MGR8 leads major functional or service areas through senior managers. EX9 sets vision, investment, and results for a complete function through multiple levels of management, with control of planning, staffing, budgeting, and approval of strategy and practice changes.

---

## EX9 — Vice President

**Example title:** Vice President of DevOps & SRE

### Core accountability

Leads a complete functional area through multiple levels of management, with overall control of planning, staffing, budgeting, and approval of changes to strategies and practices. Manages a team of directors and high-level individual contributors.

### Scope and complexity

- Develops strategic plans that ensure achievement of objectives across one or more functional areas.
- Requires in-depth knowledge of the company, the competitive environment, technology and products, and the economic or social implications of company activities.
- Participates in developing company strategies, priorities, and evaluation criteria for projects, programs, and people.
- Approves budgets and plans for a significant organization or business unit.

### Autonomy and influence

- Sets vision, direction, and resource allocation for a significant organization or business unit.
- Holds responsibility for multiple functions, departments, products, or geographies.
- Develops and implements strategic plans and objectives in alignment with company strategy.
- Oversees and approves administrative, operational, and budgetary decisions to ensure objectives are met.

### Observable evidence

- A complete function delivers sustained results under strategy this leader set.
- Investment, staffing, and prioritization decisions at this level demonstrably advance company objectives.
- Directors and senior leaders developed under this role succeed in expanded scope.
- The function's direction and performance are attributed to this leader's strategy and judgment.

### Boundary to EX10

EX9 leads one complete function. EX10 leads more than one functional area or product group through vice-president-level executives, working across functions with abstract, company-level problems.

---

## EX10 — Senior Vice President

**Example title:** Senior Vice President of Technology / Platform

### Core accountability

Leads more than one functional area or product group through vice-president-level executives who hold overall operational responsibility for their assigned functions, geographic regions, and businesses.

### Scope and complexity

- Works consistently with abstract ideas and situations across functional areas of the business.
- Through assessment of intangible variables, identifies and evaluates core issues and sets strategy and direction for major functional areas.
- Requires in-depth knowledge of the function, business strategies, and company goals, as well as external factors affecting governance of company activities.
- Integrates technology, economics, risk, and organizational design at the scale of multiple businesses.

### Autonomy and influence

- Sets vision and direction through resource-allocation decisions for multiple significant organizations or business units, each typically led by an executive.
- Develops corporate or organizational strategies and authorizes their implementation.
- Provides vision and direction to senior leaders across various groups and operations.
- Shapes company-level positioning where several functions must move together.

### Observable evidence

- Multiple executive-led organizations operate coherently under direction this leader established.
- Corporate or organizational strategies authorized at this level produce sustained, cross-business outcomes.
- Vice presidents and senior executives developed under this role succeed in expanded mandates.
- Company positioning in these areas is materially shaped by this leader's strategy.

### Boundary to EX11

EX10 leads multiple functions or business units through executives. EX11 holds company-wide accountability—setting the technology vision and the strategy to achieve the highest corporate priorities.

---

## EX11 — C-Level

**Example title:** Chief Technology Officer

### Core accountability

Holds company-wide executive accountability for technology, developing the vision and the strategy required to achieve the company's highest priorities.

### Scope and complexity

- Sets company-wide technology direction across all functions and business units.
- Integrates technology, economics, risk, customer needs, and organizational design at enterprise scale.
- Operates where corporate strategy, market position, and technical capability are inseparable.
- Accountable for outcomes whose horizon spans multiple planning cycles and competitive shifts.

### Autonomy and influence

- Develops the company-wide vision and the strategy to achieve the highest corporate priorities.
- Shapes a people-first culture and holds senior leadership accountable to the company's operating principles.
- Inspires business units to work toward a shared vision and common goals.
- Represents the company's technology direction to the board, partners, customers, and the market.

### Observable evidence

- Company strategy and market position are materially shaped by this leader's technology vision.
- The senior leadership team operates coherently against priorities this leader set.
- Enterprise-scale investments and bets attributable to this role advance the company's position.
- The leader builds durable technical leadership and culture rather than personally owning execution.
